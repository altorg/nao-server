...
DIR="/opt/nethack/nethack.alt.org/nh343/var"
XUID="5"
...
sudo ./nh343/recover -d "$DIR" "$FNAME" && \
sudo chown games.games "nh343/var/save/$FNAME" && \
sudo chmod ug+rw "nh343/var/save/$FNAME" && \
sudo gzip "nh343/var/save/$FNAME"
